...
namespace Netsoft.Diff.Algorithms.Tests
{
    public class ONDTest
    {
        ...
        public void DiffString(string[] x, string[] y, IChangeCollection<string> want)
        {
            Diff(x, y, want);
        }
        ...
        public void DiffIneger(int[] x, int[] y, IChangeCollection<int> want)
        {
            Diff(x, y, want);
        }
        ...
        public void TestDiffHandlesSequenceCotainingNull(string[] x, string[] y, IChangeCollection<string> want)
        {
            Diff(x, y, want);
        }
        ...
        public void Benchmark(int[] x, int[] y, IChangeCollection<int> want)
        {
            Diff(x, y, want);
        }
        private void Diff<T>(T[] x, T[] y, IChangeCollection<T> want)
